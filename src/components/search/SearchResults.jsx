...
/**
 * SearchResults component displaying list of audiobooks
 */
function SearchResults({ results, isLoading, error, hasSearched, onRetry }) {
  ...
  if (hasSearched && results.length === 0) {
    return (
      <div className="mt-4 bg-dark-800 rounded-2xl p-6 text-center">
        ...
        <h3 className="text-white font-semibold mb-2">Không tìm thấy kết quả</h3>
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0 py-0.5">
                <h3 className={`font-medium text-sm leading-snug line-clamp-2 ${isCurrentlyPlaying ? 'text-primary' : 'text-white'}`}>
                  {item.title}
                </h3>
